...
urlpatterns = [
    ...
    path('get-activation-key/', views.get_activation_key, name='get_activation_key'),

    #POST: activation_key, SECRET_API_MAC
    path('get-user-with-activation-key/', views.get_user_with_activation_key, name="get_user_with_authentication_key"),
